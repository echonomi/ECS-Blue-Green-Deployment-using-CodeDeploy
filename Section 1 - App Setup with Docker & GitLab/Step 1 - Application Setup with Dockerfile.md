...
>[!Note]
>If you already have an application stored in `GitHub` or `GitLab` and already have `Dockerfile`, feel free to proceed to [[Step 2 - Containerized Application with Docker| Step 2]].

### Nest.js Installation 
To Install `Nest.js`, navigate to your terminal and run the command below:
```shell
npm i -g @nestjs/cli
```

![[Pasted image 20251108141859.png]]
...
![[Pasted image 20251108195209.png]]
...
![[Pasted image 20251111102633.png]]

Next, open your browser and navigate to `http://localhost:3000`
![[Pasted image 20251111102743.png]]
